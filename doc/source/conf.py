# -*- coding: utf-8 -*-
#
# ScalyMUCK documentation build configuration file, created by
...
project = u'ScalyMUCK'
copyright = u'2014, Robert MacGregor'
...
htmlhelp_basename = 'ScalyMUCKdoc'
...
latex_documents = [
  ('index', 'ScalyMUCK.tex', u'ScalyMUCK Documentation',
   u'Robert MacGregor', 'manual'),
]
...
man_pages = [
    ('index', 'scalymuck', u'ScalyMUCK Documentation',
     [u'Robert MacGregor'], 1)
]
...
texinfo_documents = [
  ('index', 'ScalyMUCK', u'ScalyMUCK Documentation',
   u'Robert MacGregor', 'ScalyMUCK', 'One line description of project.',
   'Miscellaneous'),
]
